# \(TODO\) Auto-Renewing Subscription on Android
...
You can find that piece of information on the Google Play Publisher Console, as [explained here](subscription-android.md#retrieve-the-billing-key).
