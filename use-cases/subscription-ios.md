# \(TODO\) Auto-Renewing Subscription on iOS
...
If you followed the [Setup AppStore Application](subscription-ios.md#3-setup-appstore-application) section, you should have everything setup. Head again to the App's In-App Purchases page: select your application, then _Features_, then _In-App Purchases_.
