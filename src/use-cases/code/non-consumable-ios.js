...
window.purchaseFeature = function() {
  ...
  console.log(`Purchase button clicked for iOS non-consumable: ${productId}`);
...
function unlockFeatureAndFinish(transaction) {
  ...
  // This acknowledges the purchase with the App Store and removes it from the payment queue.
